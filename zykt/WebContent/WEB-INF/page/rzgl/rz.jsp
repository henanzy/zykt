	...
	<div id="increasedis" class="clearfix" style="overflow-x: hidden;">
		...
		<div class="mws-panel grid_8 "
			...
			<div class="mws-panel-header">
				<span class="mws-i-24 i-table-1">日志信息</span>
			</div>
			<div class="increase">
				<p>

					<span style="font-size:14px;margin-left:10px;">操作内容模糊查询 </span>
					<input id="cz" type="text" style="width:100px" />
				...
				<table class="mws-table">
					<thead>
						<tr>
							...
							<th class="table-th-css">操作内容<span class="span-up"></span> <span class="span-down"></span></th>
							<th class="table-th-css">操作时间<span class="span-up"></span> <span class="span-down"></span></th>
						</tr>
					</thead>
...
<script type="text/javascript" src="../js/rz.js"></script>
</html>