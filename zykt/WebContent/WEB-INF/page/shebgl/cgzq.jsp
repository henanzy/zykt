	...
	<div id="increasedis" class="clearfix" style="overflow: hidden;height:1000px;">
		...
		<div class="mws-panel grid_8 "
			...
			<div class="mws-panel-header">
				<span class="mws-i-24 i-table-1">层管周期</span>
			</div>
			<div class="search">
				...
				<table class="mws-table" >
					<thead>
						<tr>
							...
							<th class="table-th-css">小区名<span class="span-up"></span> <span class="span-down"></span></th>
							<th class="table-th-css">小区号<span class="span-up"></span> <span class="span-down"></span></th>
							<th class="table-th-css">楼栋号<span class="span-up"></span> <span class="span-down"></span></th>
							<th class="table-th-css">单元号</th>
							<th class="table-th-css">层号<span class="span-up"></span> <span class="span-down"></span></th>	
							<th class="table-th-css">周期</th>						
						</tr>
					</thead>
...
<script type="text/javascript" src="../js/cgzq.js"></script>
</html>