...
<script type="text/javascript" src="../js/yhsy.js"></script>
...
<body>
	...
	<div id="increasedis" class="clearfix" style="overflow-x: hidden;height:1000px;">
		...
		<div class="mws-panel grid_8 "
			...
			<div class="mws-panel-header">
				...
				&nbsp; &nbsp; &nbsp;<span style="display:inline">封盘使用数量:</span><span id="fpNum" style="display:inline" ></span>
			</div>
			<div class="search">
				<p>
					<span>选择小区：
	...
	$.ajax({
			url : "<%=basePath%>Data/findYhSy.action", 
			async : false,
			dataType : "json",
			data : {
