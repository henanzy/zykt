	...
	<div id="increasedis" class="clearfix" style="overflow-x: hidden;">
		...
		<div class="mws-panel grid_8 "
			...
			<div class="mws-panel-header">
				<span class="mws-i-24 i-table-1">风盘信息</span>
			</div>
			<div class="increase">
				<p>
			...
			<div id="xincreate_table_body" class="mws-panel-body"
				...
				<table class="mws-table">
					<thead>
						<tr>
							<!-- <th class="table-th-css">编号<span class="span-up"></span> <span class="span-down"></span></th> -->
							<!-- <th class="table-th-css">id<span class="span-up"></span> <span class="span-down"></span></th> -->
							<th class="table-th-css">风盘编号<span class="span-up"></span> <span class="span-down"></span></th>
							...
							<th class="table-th-css">位置<span class="span-up"></span> <span class="span-down"></span></th>
		...
		<div id="increase_word">
			<div class="mws-panel grid_4"
				...
				<div class="mws-panel-body" style="height: 350px;">
					<form class="mws-form" action="addFp.action" method="post">
						<div class="mws-form-inline">

							<div class="mws-form-row">
								<label>&emsp;&emsp;风盘编号：</label>

								<div class="mws-form-item large">
									<input type="text" class="mws-textinput increase_word_input" 
										name="fpbh" value="" autofocus="autofocus" />
								</div>
							</div>
		...
		<div id="change_word">
			<div class="mws-panel grid_4"
				...
				<div class="mws-panel-body" style="height: 350px;">
					<form class="mws-form" action="updateFp.action"  method="post">
						<div class="mws-form-inline">
