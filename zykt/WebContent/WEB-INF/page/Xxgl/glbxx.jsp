	...
	<div id="increasedis" class="clearfix" style="overflow-x: hidden;">
		...
		<div class="mws-panel grid_8 "
			...
			<div class="mws-panel-header">
				<span class="mws-i-24 i-table-1">功率信息</span>
			</div>
			<div class="increase">
				<p>
			...
			<div id="xincreate_table_body" class="mws-panel-body"
				...
				<table class="mws-table">
					<thead>
						<tr>
							<th class="table-th-css">型号<span class="span-up"></span> <span class="span-down"></span></th>
							<th class="table-th-css">夏高档<span class="span-up"></span> <span class="span-down"></span></th>
							<th class="table-th-css">夏中档<span class="span-up"></span> <span class="span-down"></span></th>
							<th class="table-th-css">夏低档<span class="span-up"></span> <span class="span-down"></span></th>
							<th class="table-th-css">冬高档<span class="span-up"></span> <span class="span-down"></span></th>
							<th class="table-th-css">冬中档<span class="span-up"></span> <span class="span-down"></span></th>
							<th class="table-th-css">冬低档<span class="span-up"></span> <span class="span-down"></span></th>
		...
		<div id="increase_word">
			<div class="mws-panel grid_4"
				...
				<div class="mws-panel-body" style="height: 550px;">
					<form class="mws-form" action="addGl.action" method="post">
							...
							<div class="mws-form-row">
								...
								<div class="mws-form-item large">
									<input type="text" class="mws-textinput increase_word_input" 
										name="xh" value="" autofocus="autofocus" />
								</div>
							</div>

							<div class="mws-form-row">
								<label>&emsp;&emsp;夏高档：</label>
		...
		<div id="change_word">
			<div class="mws-panel grid_4"
				...
				<div class="mws-panel-body" style="height: 550px;">
					<form class="mws-form" action="updateGl.action"  method="post">
						<div class="mws-form-inline">
						  ...
						  <div class="mws-form-row">
							...
							<div class="mws-form-row">
								...
								<div class="mws-form-item large">
									<input type="text" class="mws-textinput change_word_input" 
										name="xgkw" value="" autofocus="autofocus" />
								</div>
							</div>
...
<script type="text/javascript" src="../js/glbxx.js"></script>
</html>