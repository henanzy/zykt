	...
	<div id="increasedis" class="clearfix" style="overflow-x: hidden;">
		...
		<div class="mws-panel grid_8 "
			...
			<div class="mws-panel-header">
				<span class="mws-i-24 i-table-1">集中器信息</span>
			</div>
			<div class="increase">
				<p>
				...
				<table class="mws-table">
					<thead>
						<tr>
							...
							<th class="table-th-css">编号<span class="span-up"></span> <span class="span-down"></span></th>
							<th class="table-th-css">Ip<span class="span-up"></span> <span class="span-down"></span></th>
							<th class="table-th-css">端口号<span class="span-up"></span> <span class="span-down"></span></th>
		...
		<div id="increase_word">
			<div class="mws-panel grid_4"
				...
				<div class="mws-panel-body" style="height: 300px;">
					<form class="mws-form" action="addJzq.action" method="post">
							...
							<div class="mws-form-row">
								...
								<div class="mws-form-item large">
									<input type="text" class="mws-textinput increase_word_input" 
										name="jzqnet" value="" autofocus="autofocus" />
								</div>
							</div>

							<div class="mws-form-row">
								<label>&emsp;&emsp;Ip：</label>
		...
		<div id="change_word">
			<div class="mws-panel grid_4"
				...
				<div class="mws-panel-body" style="height: 300px;">
					<form class="mws-form" action="updateJzq.action"  method="post">
						<div class="mws-form-inline">
...
<script type="text/javascript" src="../js/jzq.js"></script>
</html>